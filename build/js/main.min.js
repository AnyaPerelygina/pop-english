...
var _simpleCursor = require("./utils/simple-cursor");
...
var _feedback = require("./modules/feedback/feedback");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _feedback.createFeedbackSlider)();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    var simpleCursor = new _simpleCursor.SimpleCursor();
    simpleCursor.init();
...
},{"./modules/feedback/feedback":2,"./modules/form-validate/form":4,"./modules/header/sticky-header":10,"./modules/header/toggle":11,"./modules/modals/init-modals":12,"./utils/ios-vh-fix":16,"./utils/simple-cursor":19}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createFeedbackSlider = void 0;
...
},{"../../utils/is-mobile":17,"../../vendor/swiper":20}],3:[function(require,module,exports){
"use strict";
...
var addToggleMenu = function addToggleMenu() {
  ...
  var nav = root.querySelector('.header__subwrapper');
